// Copia de la paleta de imagen para reutilizar en Farm
// Permite nombrar colores y mapear IDs a RGB
...
export function getColorInfo(colorId) {
...
export function closestColor(hex, palette) {
  // Sustituye por tu métrica real (ΔE o distancia RGB).
  // Por ahora retorna el primer color de la paleta
  return palette[0];
}
