export const ru = {
  ...
  image: {
    ...
    changesDetected: "🚨 Обнаружено изменений: {count}",
    repairing: "🔧 Восстановление {count} изменённых пикселей...",
    repairCompleted: "✅ Восстановление завершено: {count} пикселей",
    noChargesForRepair: "⚡ Комиссий за восстановление нет, ожидание...",
    protectionPriority: "🛡️ Приоритет защиты активирован",
  ...
  guard: {
    ...
    capturingArea: "📸 Захват области защиты...",
    ...
    protectionStarted: "🛡️ Защита запущена - мониторинг области",
    protectionStopped: "⏹️ Защита остановлена",
    noChanges: "✅ Защищенная область - изменений не обнаружено",
    changesDetected: "🚨 {count} изменений обнаружено в защищенной области",
    ...
    checkingChanges: "🔍 Проверка изменений в защищенной области...",
    errorChecking: "❌ Ошибка проверки изменений: {error}",
    guardActive: "🛡️ Страж активен - область под защитой",
    ...
    clickingPaintButton: "👆 Нажатие кнопки «Paint»...",
    paintButtonNotFound: "❌ Кнопка «Paint» не найдена",
    selectUpperLeft: "🎯 Нарисуйте пиксель в ВЕРХНЕМ ЛЕВОМ углу области для защиты",
