export const en = {
  ...
  overlayOff: "Overlay: OFF",
    ...
    changesDetected: "🚨 {count} changes detected in drawing",
    repairing: "🔧 Repairing {count} altered pixels...",
  ...
  guard: {
    ...
    capturingArea: "📸 Capturing protection area...",
    ...
    protectionStarted: "🛡️ Protection started - monitoring area",
    protectionStopped: "⏹️ Protection stopped",
    noChanges: "✅ Protected area - no changes detected",
    changesDetected: "🚨 {count} changes detected in protected area",
    ...
    checkingChanges: "🔍 Checking changes in protected area...",
    errorChecking: "❌ Error checking changes: {error}",
    guardActive: "🛡️ Guardian active - area under protection",
    ...
    clickingPaintButton: "👆 Clicking Paint button...",
    paintButtonNotFound: "❌ Paint button not found",
    selectUpperLeft: "🎯 Paint a pixel at the UPPER LEFT corner of the area to protect",
