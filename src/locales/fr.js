export const fr = {
  ...
  image: {
    ...
    guardExportSuccess: "✅ Exporté pour Auto-Guard : {filename}",
  ...
  overlayOff: "Overlay : OFF",
    ...
    changesDetected: "🚨 {count} changements détectés dans le dessin",
    repairing: "🔧 Réparation de {count} pixels modifiés...",
    repairCompleted: "✅ Réparation terminée : {count} pixels",
